...
TW_IGNORE_SYSTEM_FSTAB := true
TW_USE_ORIGINAL_FSTAB := $(TARGET_RECOVERY_FSTAB)
TW_CUSTOM_CPU_TEMP_PATH := /sys/class/thermal/thermal_zone28/temp
TARGET_USE_CUSTOM_LUN_FILE_PATH := /config/usb_gadget/g1/functions/mass_storage.usb0/lun.%d/file

# Init Library (from pond)
...
TW_F2FS_MOUNT_OPTIONS := rw,noatime,nosuid,nodev,discard,inlinecrypt,alloc_mode=default,fsync_mode=nobarrier
...
# Crypto - FIXED FOR DECRYPTION (from pond)
PLATFORM_VERSION := 99
...
TW_INCLUDE_F2FS_FBE := true
TW_CRYPTO_USE_SYSTEM_VOLD := true
TW_CRYPTO_USE_ANDROID_VOLD := true
