...
# Crypto - FIXED (Enabled Decryption)
...
# MediaTek Specific Decryption Flags
TW_CRYPTO_USE_SYSTEM_VOLD := false
TW_CRYPTO_USE_SYSTEM_LIBKEYMASTER := false
TW_CRYPTO_USE_SYSTEM_ADDITIONAL_VOLD := false
TW_CRYPTO_LEGACY_HW_SERVICE := false
